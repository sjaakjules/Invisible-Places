...
- Camera shot save/load, ordered camera paths, quaternion interpolation, 30 fps timing, CPU-assisted surface pivot picking, selected-key camera/focus relationship lines, one-third-position shared-rig cube gizmos with standard axis/plane translation, retained focus-key world-Z orbit handles, and transactional focus-node Live Edit Mode with full camera/lens capture.
