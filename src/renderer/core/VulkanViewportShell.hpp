...
struct ViewportDiagnostics {
    ...
    std::uint32_t adaptiveGpuCompactionDispatchedDrawItems = 0;
    ...
    bool adaptiveGpuFeatureClassProbeUsed = false;
    std::string adaptiveGpuFeatureClassProbeParityStatus = "not checked";
    std::uint32_t adaptiveGpuFeatureClassProbeDispatches = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeMask = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeCpuCount = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeGpuCount = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeCpuSourceFingerprint = 0;
    std::uint32_t adaptiveGpuFeatureClassProbeGpuSourceFingerprint = 0;
    double adaptiveGpuFeatureClassProbeCpuReferenceMs = 0.0;
    double adaptiveGpuFeatureClassProbeMs = 0.0;
    bool adaptiveGpuRankProbeUsed = false;
    std::string adaptiveGpuRankProbeParityStatus = "not checked";
    std::uint32_t adaptiveGpuRankProbeDispatches = 0;
    std::uint32_t adaptiveGpuRankProbeLimit = 0;
    std::uint32_t adaptiveGpuRankProbeCpuCount = 0;
    std::uint32_t adaptiveGpuRankProbeGpuCount = 0;
    std::uint32_t adaptiveGpuRankProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuRankProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuRankProbeCpuSourceFingerprint = 0;
    ...
    bool adaptiveGpuRankProbeOutputWriteEnabled = false;
    std::string adaptiveGpuRankProbeOutputFallbackReason;
    std::uint32_t adaptiveGpuRankProbeOutputCapacity = 0;
    std::uint32_t adaptiveGpuRankProbeCopiedDrawItems = 0;
    std::string adaptiveGpuRankProbeOutputParityStatus = "not checked";
    std::uint32_t adaptiveGpuRankProbeOutputCpuCount = 0;
    std::uint32_t adaptiveGpuRankProbeOutputGpuCount = 0;
    std::uint32_t adaptiveGpuRankProbeOutputCpuChecksum = 0;
    std::uint32_t adaptiveGpuRankProbeOutputGpuChecksum = 0;
    std::uint32_t adaptiveGpuRankProbeOutputCpuSourceFingerprint = 0;
    std::uint32_t adaptiveGpuRankProbeOutputGpuSourceFingerprint = 0;
    ...
    float adaptiveGpuProjectedAreaProbeMinFootprintAreaPixels = 0.0F;
    float adaptiveGpuProjectedAreaProbeMaxFootprintAreaPixels = 0.0F;
    float adaptiveGpuProjectedAreaProbeMinRenderAreaPixels = 0.0F;
    float adaptiveGpuProjectedAreaProbeMaxRenderAreaPixels = 0.0F;
    std::uint32_t adaptiveGpuProjectedAreaProbeCpuCount = 0;
    std::uint32_t adaptiveGpuProjectedAreaProbeGpuCount = 0;
    std::uint32_t adaptiveGpuProjectedAreaProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuProjectedAreaProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuProjectedAreaProbeCpuSourceFingerprint = 0;
    std::uint32_t adaptiveGpuProjectedAreaProbeGpuSourceFingerprint = 0;
    double adaptiveGpuProjectedAreaProbeCpuReferenceMs = 0.0;
    double adaptiveGpuProjectedAreaProbeMs = 0.0;
    bool adaptiveGpuRenderAreaProbeUsed = false;
    std::string adaptiveGpuRenderAreaProbeParityStatus = "not checked";
    std::uint32_t adaptiveGpuRenderAreaProbeDispatches = 0;
    float adaptiveGpuRenderAreaProbeMinFootprintAreaPixels = 0.0F;
    float adaptiveGpuRenderAreaProbeMaxFootprintAreaPixels = 0.0F;
    float adaptiveGpuRenderAreaProbeMinRenderAreaPixels = 0.0F;
    float adaptiveGpuRenderAreaProbeMaxRenderAreaPixels = 0.0F;
    std::uint32_t adaptiveGpuRenderAreaProbeCpuCount = 0;
    std::uint32_t adaptiveGpuRenderAreaProbeGpuCount = 0;
    std::uint32_t adaptiveGpuRenderAreaProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuRenderAreaProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuRenderAreaProbeCpuSourceFingerprint = 0;
    std::uint32_t adaptiveGpuRenderAreaProbeGpuSourceFingerprint = 0;
    double adaptiveGpuRenderAreaProbeCpuReferenceMs = 0.0;
    double adaptiveGpuRenderAreaProbeMs = 0.0;
    bool adaptiveGpuRepresentedCountProbeUsed = false;
    std::string adaptiveGpuRepresentedCountProbeParityStatus = "not checked";
    std::uint32_t adaptiveGpuRepresentedCountProbeDispatches = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeMinRepresentedSourceCount = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeMaxRepresentedSourceCount = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeCpuCount = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeGpuCount = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeCpuSourceFingerprint = 0;
    std::uint32_t adaptiveGpuRepresentedCountProbeGpuSourceFingerprint = 0;
    double adaptiveGpuRepresentedCountProbeCpuReferenceMs = 0.0;
    double adaptiveGpuRepresentedCountProbeMs = 0.0;
    bool adaptiveGpuCoverageCompensationProbeUsed = false;
    std::string adaptiveGpuCoverageCompensationProbeParityStatus = "not checked";
    std::uint32_t adaptiveGpuCoverageCompensationProbeDispatches = 0;
    float adaptiveGpuCoverageCompensationProbeMinOpacityCompensation = 0.0F;
    float adaptiveGpuCoverageCompensationProbeMaxOpacityCompensation = 0.0F;
    float adaptiveGpuCoverageCompensationProbeMinEmissionCompensation = 0.0F;
    float adaptiveGpuCoverageCompensationProbeMaxEmissionCompensation = 0.0F;
    std::uint32_t adaptiveGpuCoverageCompensationProbeCpuCount = 0;
    std::uint32_t adaptiveGpuCoverageCompensationProbeGpuCount = 0;
    std::uint32_t adaptiveGpuCoverageCompensationProbeCpuChecksum = 0;
    std::uint32_t adaptiveGpuCoverageCompensationProbeGpuChecksum = 0;
    std::uint32_t adaptiveGpuCoverageCompensationProbeCpuSourceFingerprint = 0;
...
class VulkanViewportShell {
  ...
  private:
    ...
    struct ActivePointCloudResources {
        ...
        std::array<BufferAllocation, kFramesInFlight> gpuRankProbeOutputDrawItemBuffers{};
        ...
        std::array<BufferAllocation, kFramesInFlight> gpuRenderAreaProbeStatsBuffers{};
        ...
        std::array<VkDescriptorSet, kFramesInFlight> gpuRenderAreaProbeDescriptorSets{};
        ...
        std::array<std::uint32_t, kFramesInFlight> gpuRankProbeOutputDrawItemCapacities{};
        ...
        std::array<GpuDrawItemCompactionStats, kFramesInFlight> gpuFeatureClassProbeExpectedStats{};
        ...
        std::array<GpuDrawItemOutputProbeStats, kFramesInFlight> gpuRankProbeExpectedOutputProbeStats{};
        std::array<bool, kFramesInFlight> gpuRankProbeOutputProbeResultPending{};
        ...
        std::array<GpuDrawItemCompactionStats, kFramesInFlight> gpuRenderAreaProbeExpectedStats{};
        std::array<bool, kFramesInFlight> gpuRenderAreaProbeResultPending{};
    ...
    struct FrameResources {
        ...
        std::array<bool, 15U> timestampPassWritten{};
    };
    ...
    void UpdateGpuRenderAreaProbeDescriptorSet(ActivePointCloudResources* resources, std::size_t frameIndex);
