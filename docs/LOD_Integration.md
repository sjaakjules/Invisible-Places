...
prefix-selection/performance-clamped represented-count-limited projected-footprint depth-windowed rank-and-feature-class filtering/compaction/checksum diagnostics for
...
- GPU-driven selection policy support exists. The renderer checks compute-queue
  ...
  metadata decoded, prefix-filtered through a performance-clamped represented-count-limited projected-footprint
...
- Stage 11 sample evidence on `Data/Site3-Sample-Terrestrial.ply` completed
  ...
  performance-clamped represented-count-limited projected-footprint depth-windowed rank-limited feature prefix dispatch over
  ...
  0, represented-count window 2-4,294,967,295 and projected footprint/render
  area window 1-1.04858e+06 px, compacted up to 5,515 items at 1.75817 ms,
  ...
  GPU indirect-command dispatch at 0.503375 ms. Beauty stress recorded 1 GPU
  performance-clamped represented-count-limited projected-footprint
  ...
  window 2-255, required flags 4, and rejected flags 0, compacted up to 4,318
  items at 2.6285 ms, matched previous-frame CPU/GPU count 2,301 with checksum
  933,328,382, and matched compacted indirect CPU/GPU vertices 2,301 / 2,301.
  Coverage ratio
...
- GPU prefix-selection/compaction parity/status/input/selection/class-mask/rank-limit/depth-window/projected-footprint-window/represented-source-count-window/required-flags/rejected-flags/count/checksum/ms
