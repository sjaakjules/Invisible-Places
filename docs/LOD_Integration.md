...
- `lod_compare_metrics.json` schema v3 reports source/cache fingerprints,
  ...
  profile-mask/opacity-window/emission-window/frustum enabled/guard/fallback/output-write/fallback/position-count fields,
