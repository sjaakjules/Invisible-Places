...
- Seepage look controls cover persistent dampness, density, glisten, pattern scale, wavelength, speed, warp, turbulence, phase, rain response, and the shared water blend/visual response. Rain changes visual strength without changing Seepage topology.
...
- Project serialization uses schema version 34 for the current project shape; standalone water-source documents use schema version 11.
